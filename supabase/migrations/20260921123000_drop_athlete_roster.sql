...
-- the narrowest thing that could work, but still a hole cut in the wall, and
-- `athlete_email` in particular turned a name anyone could see into the
-- address behind it.
--
-- Signing in is an address and a password now. Nothing calls either function,
-- and a definer-rights function that hands out addresses is not something to
